...
namespace PracticaCalifica_ChristianHinojosa.Controllers
{
    ...
    public class EstudiantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Codigo,Apellidos,Nombres,Correo,Activo")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Codigo,Apellidos,Nombres,Correo,Activo")] Estudiante estudiante)
        {
            if (ModelState.IsValid)
            {
